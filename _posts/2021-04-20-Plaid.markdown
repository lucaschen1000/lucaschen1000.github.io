...
This problem is basically asking us to factor p and q given $$n = pq$$ and $$x = p\oplus q$$.
...
If you're confused on step 3, [compare the gf128 function to page 8 of this pdf](https://csrc.nist.rip/groups/ST/toolkit/BCM/documents/proposedmodes/gcm/gcm-spec.pdf).
